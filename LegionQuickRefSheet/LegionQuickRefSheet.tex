...
%\setmonofont[Scale=0.8]{Source Code Pro} % Not visually different enough (to Source Sans Pro) to highlight code...
...
\code{node-a01 -- node-j64} & W & 628 & 4 & 16 GB & \checkmark \\
\code{node-k01 -- node-p24} & X & 144 & 12 & 24 GB & \checkmark  \\
\code{node-001 -- node-108} & Y & 108 & 12 & 24 GB & \texttimes    \\
\code{node-202 -- node-212} & Z & 4 & 12 & 48 GB & \texttimes  \\
\code{node-301 -- node-308} & V & 8 & 12 & 48 GB & \texttimes  \\
\code{node-513 -- node-528} & U & 16 & 16 & 64 GB & \texttimes  \\
...
Many example job scripts are available from our website, both generic and for specific applications.
